export const data = [
  {
    ...
    shortDescription:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Tellus mauris a diam maecenas sed enim ut sem viverra. Neque viverra justo nec ultrices dui sapien eget mi proin. Amet consectetur adipiscing elit ut aliquam purus sit amet.",
    certificate: true,
    liveBroadcast: true,
    simulation: false,
  },
  ...
  },
  {
    ...
    instructor: "Jon Mann",
    shortDescription:
      "No harum consetetur sed. Per ex dolorem rationibus. Vero aliquando pro eu. Pri ea hinc delicatissimi concludaturque, quot veniam sensibus usu ei, cibo illud copiosae no vix. Iusto efficiantur eum an, elit regione ne per.",
    certificate: true,
    liveBroadcast: false,
    simulation: true,
  },
